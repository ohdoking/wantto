...
import com.uni.unitonwanttoapp.main.SlidingUpPanelLayout;
...
public class MainFragment extends Fragment implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_todolist, container, false);
        ...
        mTransparentHeaderView = inflater.inflate(R.layout.activity_todolist_longmap, mListView, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mListView.setAdapter(new ArrayAdapter<String>(getActivity(), R.layout.activity_todolist_shortmap, testData));
